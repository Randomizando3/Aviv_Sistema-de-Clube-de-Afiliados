...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* GRID DA PRIMEIRA SEÇÃO (quebra no mobile) */
    .why-grid{display:grid;grid-template-columns:1.2fr 1fr;gap:28px;align-items:center}
    @media (max-width: 900px){
      .why-grid{grid-template-columns:1fr}
      .why-grid figure{order:-1}
    }

    /* PARTNERS.PNG ocupando a linha toda */
    .logos-shelf--4{
      display:grid;
    ...
    .control{
      ...
      border-radius:12px;
      padding:14px 14px;
      font:600 .95rem/1.25 "Open Sans",system-ui,-apple-system,Segoe UI,Roboto,Arial,sans-serif;
      color:var(--ink);
    ...
    .partner-pill__text{display:inline-block;line-height:1.1;white-space:nowrap}
    @media (max-width:420px){ .partner-pill__text{white-space:normal} }

    .partner-pill--whats{border-color:color-mix(in oklab, var(--whats) 30%, #0000)}
...
<body class="site-page">
      ...
      <div class="why-grid">
        <div>
          ...
          <div style="margin-top:16px">
            <a class="btn btn--blueGrad" href="#cadastro-parceiro">Quero ser parceiro</a>
          </div>
        </div>

        <figure style="margin:0">
          <img src="/img/hero.jpg" alt="Rede de parceiros Aviv+" style="width:100%;height:auto;border-radius:16px">
        </figure>
      </div>
    </div>
  </section>
      ...
      <div class="steps">
        <div class="step">
          <div style="display:flex;align-items:center;gap:12px;margin-bottom:10px">
            <span class="step-chip">1</span><h3>Cadastro</h3>
          </div>
          <p class="section__desc">Envie seus dados e condições comerciais. Validamos e ativamos seu perfil.</p>
        </div>

        <div class="step">
          <div style="display:flex;align-items:center;gap:12px;margin-bottom:10px">
            <span class="step-chip">2</span><h3>Divulgação</h3>
          </div>
          <p class="section__desc">Sua marca passa a aparecer nas comunicações e na área do cliente.</p>
        </div>

        <div class="step">
          <div style="display:flex;align-items:center;gap:12px;margin-bottom:10px">
            <span class="step-chip">3</span><h3>Atendimento</h3>
          </div>
          <p class="section__desc">Receba clientes com a carteirinha e acompanhe os resultados.</p>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="section__head section__head--center">
        ...
        <div class="partner-contact" aria-label="Contato comercial para empresas">
          ...
          <a class="partner-pill partner-pill--whats" href="https://wa.me/5521999438907" target="_blank" rel="noopener" aria-label="Chamar no WhatsApp +55 21 99943-8907">
  ...
  <section class="section cta--bar" aria-label="Assine agora">
    ...
    <div class="container cta__wrap">
      ...
      <div class="cta__actions" style="display:flex;gap:12px;flex-wrap:wrap">
