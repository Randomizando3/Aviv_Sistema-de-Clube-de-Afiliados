...
/* tamanhos mínimos */
.ta-min--create{ min-height:140px; }
.ta-min--list{   min-height:170px; }
...
@media (min-width:1100px){
  .bens-cards{ grid-template-columns:1fr 1fr; }
}
...
.combo-opt input{ accent-color:#6366f1; }
.combo-actions{
  display:flex;
  justify-content:space-between;
  gap:8px;
